...
class ThisPage extends Page {
	...
	function process() {
        ...
        //순서변경
        $this->arrData['onclick_change_up'] = "changeOrder('up','staff','?tpf=admin/setting/staff');";
        $this->arrData['onclick_change_down'] = "changeOrder('down','staff','?tpf=admin/setting/staff');";
	}
